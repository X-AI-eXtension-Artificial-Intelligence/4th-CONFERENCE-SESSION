...
def make_parser():
    ...
    parser.add_argument(
        "-f", "--exp_file",
        default='HybridSORT/exps/example/mot/yolox_x_mix_mot20_ch_hybird_sort_reid.py',
        type=str,
    ...
    parser.add_argument('--out_path_inpaint', type=str, help="path to save output results (inpaint)")
...
# for input bbox
    parser.add_argument(
        "--input_bbox", help='Input bbox coordinate to select non-removal object'
    )
    return parser
